...
def resolve_layer_style(layer_meta: dict[str, Any], styles: dict[str, Any]) -> dict[str, Any]:
    ...
    elif stem.startswith("renda_") and stem not in layers_cfg:
        # Arquivos renda_ herdam de renda_quixeramobim
        per = layers_cfg.get("renda_quixeramobim") or {}
    elif stem.startswith("popula_") and stem not in layers_cfg:
        # Arquivos popula_ herdam de popula_quixeramobim
        per = layers_cfg.get("popula_quixeramobim") or {}
    else:
